...
function e(e2, s2) {
  ...
  const r = s2.signal;
  return delete s2.signal, globalThis.invokeStaticMessage("request", { url: e2, options: s2 }, { signal: r }).then(((n) => __async(null, null, function* () {
    let o, i, l, u, c;
    if (n.data) if (n.data instanceof ArrayBuffer) {
      if (!("json" !== a && "text" !== a && "blob" !== a || (o = new Blob([n.data]), "json" !== a && "text" !== a || (u = yield o.text(), "json" !== a)))) {
        try {
          ...
          const a2 = __spreadProps(__spreadValues({}, p), { url: e2, requestOptions: s2 });
          throw new s("request:server", p.message, a2);
        }
        if (i.error) {
          const a2 = __spreadProps(__spreadValues({}, i.error), { url: e2, requestOptions: s2 });
...
//# sourceMappingURL=chunk-D7EUSBNY.js.map

...
var _Dialog = class _Dialog extends LitElement {
  constructor() {
    super(...arguments);
    this.dragPosition = __spreadValues({}, initialDragPosition);
    ...
    this.resizePosition = __spreadValues({}, initialResizePosition);
  ...
  scrollContentTo(options) {
    return __async(this, null, function* () {
      yield this.panelEl.value?.scrollContentTo(options);
    });
  }
  setFocus(options) {
    return __async(this, null, function* () {
  ...
  updateFocusTrapElements(extraContainers) {
    return __async(this, null, function* () {
  ...
  triggerInteractModifiers() {
    return __async(this, null, function* () {
      const { interaction } = this;
      if (!interaction) {
        return;
      }
      yield interaction.reflow({
        name: "drag"
      });
      yield interaction.reflow({
        name: "resize"
  ...
  setupInteractions() {
    return __async(this, null, function* () {
      ...
      if (resizable) {
        yield this.el.componentOnReady();
...
@esri/calcite-components/dist/components/calcite-dialog/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=chunk-QYONNX2H.js.map

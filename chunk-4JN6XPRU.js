...
var d = class {
  ...
  addQueryGeometry(e, t) {
    ...
    e.queryGeometryType = i2, e.queryGeometry = __spreadValues({}, a2);
  }
...
function n3(o3, s, n4, p) {
  return __async(this, null, function* () {
    const i2 = f(o3), u2 = __spreadValues({}, n4), m = R.from(s), f3 = !m.quantizationParameters, { data: c } = yield f2(i2, m, new d({ sourceSpatialReference: m.sourceSpatialReference, applyTransform: f3 }), u2, p);
    return c;
  });
}
...
//# sourceMappingURL=chunk-4JN6XPRU.js.map

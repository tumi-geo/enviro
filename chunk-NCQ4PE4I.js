...
function r2() {
  return __async(this, null, function* () {
    const s3 = has("esri-csp-restrictions") ? yield import("./chunk-ZABO2XWT.js").then(((t) => t.l)) : yield import("./chunk-QWPT3OVR.js").then(((t) => t.l));
    e2 = yield s3.default({ locateFile: (s4) => n(`esri/core/libs/libtess/${s4}`) });
  });
}
function a2(t, n5) {
...
//# sourceMappingURL=chunk-NCQ4PE4I.js.map

...
function n2(e, t, r, o, s3) {
  return __async(this, null, function* () {
    ...
    yield e.update({ data: t }), yield h(a, o, s3);
  });
}
function u(o, p3, n3) {
  return __async(this, null, function* () {
    ...
    for (const e of p3.resources.toUpdate) if (u2.delete(e.resource.path), h2.has(e.resource.path) || i.has(e.resource.path)) {
      ...
      o.paths.push(n4.path), f.push({ resource: n4, content: yield p(r), compress: e.compress }), p4 && w.push((() => p4(n4)));
    } else {
      o.paths.push(e.resource.path), l.push({ resource: e.resource, content: yield p(e.content), compress: e.compress });
      const t = e.finish;
    ...
    for (const e of p3.resources.toAdd) if (o.paths.push(e.resource.path), u2.has(e.resource.path)) u2.delete(e.resource.path);
      ...
      f.push({ resource: e.resource, content: yield p(e.content), compress: e.compress });
      const t = e.finish;
      t && w.push((() => t(e.resource)));
    }
    if (f.length || l.length) {
      const { addOrUpdateResources: e } = yield import("./chunk-U26POD6B.js");
...
//# sourceMappingURL=chunk-4U6GJR4R.js.map
